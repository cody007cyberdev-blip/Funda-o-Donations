...
const WaysToFundSection = ({boxProps, subtitleProps}: IProps) => {
    ...
    return (
        <Box style={{background: theme.colors.secondary[8], color: theme.white}} {...boxProps}>
                    ...
                    <Grid.Col span={{ base: 12, lg: 8 }}>
                        <SimpleGrid cols={{ base: 1, sm: 3 }} gap="md">
                            ...
                            >
                                ...
                                <Text mt="md" ta="center" {...subtitleProps}>Para Si Mesmo</Text>
                            </Card>
                            <Card
                                className={cx(classes.feature, 'card')}
                                shadow="md"
                            ...
                            >
                                ...
                                <Text mt="md" ta="center" {...subtitleProps}>Amigos & Família</Text>
                            </Card>
                            <Card
                                className={cx(classes.feature, 'card')}
                                shadow="md"
                            ...
                            >
                                ...
                                <Text mt="md" ta="center" {...subtitleProps}>Instituição de Caridade</Text>
                            </Card>
                        </SimpleGrid>
                    </Grid.Col>
                </Grid>
