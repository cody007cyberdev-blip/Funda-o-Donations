...
const useStyles = createStyles((theme) => ({
    wrapper: {
        ...
        backgroundImage: 'url(/src/assets/img/tema.png)', // Imagem local
                ...
                <Container>
                    <Stack spacing="xl">
                        ...
                        <Title className={classes.title}>
                            Ajude as pessoas, faça <Text
                            component="span"
                            inherit
                            variant="gradient"
                            gradient={{from: theme.colors.lime[5], to: theme.colors.green[4]}}
                        >grandes mudanças</Text> e <Text
                            component="span"
                            inherit
                            variant="gradient"
                            gradient={{from: theme.colors.green[4], to: theme.colors.lime[5]}}
                        >transforme este mundo.</Text>
                        </Title>
                        <Text size="lg" className={classes.description}>
                            Junte-se a nós e faça parte de algo especial. Juntos podemos fazer a diferença e tornar os seus sonhos em realidade.
                        </Text>
                    </Stack>
                </Container>
