...
const data = [
    {link: '/create-campaign', label: 'Criar Nova Campanha', icon: IconFolderPlus},
    {link: '/dashboard', label: 'O Meu Painel', icon: IconHome},
    {link: '', label: 'Campanhas que Sigoo', icon: IconHeart},
    {link: '', label: 'Campanhas Financiadas', icon: IconFileDollar},
];
...
const AppLinks = ({...others}: IProps) => {
    ...
    const [active, setActive] = useState('Criar Nova Campanha');
